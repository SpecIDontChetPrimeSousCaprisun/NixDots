...
µb.formatCount = function(count: unknown): string {
...
µb.dateNowToSensibleString = function(): string {
...
µb.openNewTab = function(details: TabDetails): void {
    if ( details.url.startsWith('logger-ui.html') ) {
        ...
        if ( this.userSettings.alwaysDetachLogger ) {
            ...
            try {
                ...
                console.warn('[uBR] utils: popupLoggerBox JSON parse failed', 'popupLoggerBox', e);
            }
...
µb.escapeRegex = function(s: string): string {
    return s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
};

/******************************************************************************/

µb.getModifiedSettings = function(edit: Record<string, unknown>, orig: Record<string, unknown> = {}): Record<string, unknown> {
...
µb.settingValueFromString = function(orig: Record<string, unknown>, name: string, s: string): unknown {
    ...
    case 'number':
        ...
        if ( isNaN(r as number) ) { r = undefined; }
        break;
    default:
        break;
    }
