...
const isYouTubeProtectedUINode = node =>
    isYouTubeHostname(self.location.hostname) &&
    node instanceof Element &&
    node.matches(youtubeProtectedUISelector);
...
class PSelectorRoot extends PSelector {
    ...
    prime(input) {
        try {
            ...
            console.warn('[uBR] contentscript-extra: PSelectorRoot.prime failed', e);
        }
        return [];
    }
}
