...
export class JSONPath {
    ...
    compile(query) {
        ...
        if ( r.i !== query.length ) {
            ...
            catch (e) { console.warn('[uBR] jsonpath: JSON.parse val failed', e); return; }
        }
        this.#compiled = r;
    }
    evaluate(root) {
    ...
    #compileExpr(query, step, i) {
        ...
        try {
            ...
            console.warn('[uBR] jsonpath: JSON parse failed', match[2], e);
        }
        ...
        case 'repl': {
            ...
            if ( this.#compiled.re === undefined ) {
                ...
                try {
                    ...
                    console.warn('[uBR] jsonpath: RegExp construction failed', rval, e);
                }
            }
